...
{
	$id=$_GET["mis"];
	$sql2="UPDATE  selected_student SET status=1 where mis='$id'";
...
echo '</tr>';
                                                   ...
                                                   echo'<td>'.$row_select["mis"].'</td>';
                                                    ...
                                                    echo'<td><form action="studentagg.php?mis=';echo $row_select["mis"];echo'"';echo' method="post"><button /type="submit" name="submit">Submit</button></form></td>';
